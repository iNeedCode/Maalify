...
feature 'Sign Up', :devise do
  ...
  scenario 'visitor cannot sign up without password' do
    ...
    expect(page).to have_content "Password muss ausgefüllt werden"
  end
  ...
  scenario 'visitor cannot sign up with a short password' do
    ...
    expect(page).to have_content "Password ist zu kurz"
  end
  ...
  scenario 'visitor cannot sign up without password confirmation' do
    ...
    expect(page).to have_content "Password confirmation stimmt nicht"
  end
  ...
  scenario 'visitor cannot sign up with mismatched password and confirmation' do
    ...
    expect(page).to have_content "Password confirmation stimmt nicht mit Password"
  end
